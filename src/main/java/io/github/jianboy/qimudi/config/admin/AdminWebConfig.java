package io.github.jianboy.qimudi.config.admin;
/**
 * 用来配置后台拦截器的配置类
 */
import io.github.jianboy.qimudi.constant.RuntimeConstant;
import io.github.jianboy.qimudi.interceptor.admin.AdminLoginInterceptor;
import io.github.jianboy.qimudi.interceptor.admin.AuthorityInterceptor;
